...
<template>
    <div v-if="loadSuccess">
        <section class="waysSection">
            <!-- Заголовок секции -->
            <TitleSection :title="this.titleWays" :headerVisible="visibleWays" style="margin-bottom: 100px" />
            <!-- Итемы направлений -->
            <WaysSection v-for="(waysItem, index) in WAYS_ARRAY.WAYS_ITEM" :key="waysItem" :sectionData="waysItem" :index="index" />
        </section>
    </div>
