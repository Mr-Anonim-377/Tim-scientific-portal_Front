<template>
    <div v-if="loadSuccess">
        <section class="admin">
            ...
            <router-link style="text-decoration: none" :to="{ name: 'FormDocuments', params: { mode: 'create' } }">
                <button class="btn_add">Добавить документ</button>
            </router-link>
            ...
            <!-- TODO Поправить type-->
            <AdminItem :sectionData="items" formName="FormNews" type="DOCUMENTS" />
        </section>
    </div>
