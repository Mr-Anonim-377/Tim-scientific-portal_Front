<template>
    <div v-if="loadSuccess">
        <section class="admin">
            ...
            <router-link style="text-decoration: none" :to="{ name: 'FormResearch', params: { mode: 'create' } }">
            ...
            <!-- список-->
            <AdminItem :sectionData="availableEntities" formName="FormResearch" type="RESEARCH" />
        </section>
    </div>
