        ...
        <section>
            ...
            <el-form ref="form" :model="form" class="form" :rules="rules">
                        ...
                        >
                            ...
                            <template #tip>
                                <div class="el-upload__tip">
                                    До 7 изображений для отображения в слайдере
                                </div>
                                <div class="el-upload__tip">
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item>
                            ...
                            >
                                ...
                                <template #tip>
                                    <div class="el-upload__tip">
                                        1 изображение для отображения в ленте
                                        новостей
                                    </div>
                                    <div class="el-upload__tip">
                ...
                <div class="form">
                    ...
                    <div class="tips">
                        <p @click="showTips = !showTips">
                            Правила форматирования текста для новости
                        </p>

                        <el-collapse-transition>
                            <div v-if="showTips" class="tips_wrapper">
                                <p class="tips_h1">
                                    Для форматирования текста новости можно
                                    использовать:
                                </p>
                                <div class="tips_item">
                                    <div class="tips_title">
                                        ...
                                        <p class="tips_h3">
                                            ** В начале и в конце выделения
                                        </p>
                                    </div>

                                    <div class="tips_example">
                                        <p class="tips_h2">
                                            Пример жирного выделения:
                                        </p>
                                ...
                                <div class="tips_item">
                                    <div class="tips_title">
                                        ...
                                        <p class="tips_h3">
                                            &gt;&gt; В начале элемента списка
                                        </p>
                                        <p class="tips_h3">
                                            &lt;&lt; В конце элемента списка
                                        </p>
                                    </div>
...
export default {
    ...
    async mounted() {
        ...
        if (this.mode === 'edit') {
            ...
            /* Заполняем инпуты */
            this.form.text = this.transformHTMLtoString(
                this.NEWS_TEXT.TEXT[0].text
            );
            this.form.title = this.NEWS_TITLE.TITLE[0].title;
            this.sliderFileList = this.NEWS_IMAGE_CAROUSEL?.IMAGE?.map(
                (image, i) => {
                    return {
