		...
		<section class="dynamics">
			<div class="dynamics-container">
				<TitleSection
					...
					:headerVisible="true"
					:styleTitle="styleTitle.styleDynamics"
				/>

				<ProgressItem v-for="progressBar in DYNAMIC_GOALS.DYNAMIC_GOAL" :key="progressBar" :sectionData="progressBar" />
			</div>
		</section>
	</div>
	...
	export default {
		...
		data() {
			return {
				 ...
				 */
				styleTitle: {
					style: ['font-size: 26px; letter-spacing: 0.01em; margin-bottom: 94px;'],
