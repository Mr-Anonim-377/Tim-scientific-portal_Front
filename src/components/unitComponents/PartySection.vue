// СТРАНИЦА УЧАСТНИКОВ КОНСОРЦИУМА

<template>
    <section class="partySection">
        <TitleSection :header-visible="visibleParty" :title="title" />
        <div v-if="sectionData" class="party-container" :style="listResearch">
            <div
                v-for="researcher in sectionData"
                :key="researcher.text"
                class="party-block"
            >
                <div v-if="researcher._pageLink">
                    <router-link
                        ...
                        :to="{ path: `/form/${researcher._pageLink}` }"
                    >
                        <div
                ...
                <div class="party-block__right">
                    ...
                    >
                        <div
                            v-for="research in researcher._childModuleObject"
                            :key="research.id"
                            class="project-container-block"
                        >
                            <router-link
                                style="text-decoration: none"
                                :to="{ path: `/research/${research.pageLink}` }"
                            >
                                <img
                                    :src="
                    ...
                    <div v-else class="project-container-none"></div>
                </div>
            </div>
        </div>

        <div v-else class="researchersEmpty">
