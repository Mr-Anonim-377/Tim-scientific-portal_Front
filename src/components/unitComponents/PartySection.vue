...
<template>
	<section class="partySection">
		<TitleSection :headerVisible="visibleParty" :title="this.titleParty" />
		<div v-for="dataTitle in sectionData" :key="dataTitle">
			...
			<div class="party-container" :style="listResearch">
				<div class="party-block" v-for="dataUsers in dataTitle.users" :key="dataUsers">
			...
			<p
				v-if="dataTitle.users.length > 6"
				class="partySection__text"
				:style="btnStyle"
				@click="showToggle"
			>
				Смотреть еще
