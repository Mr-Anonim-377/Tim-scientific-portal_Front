<template>
    <section class="partySection">
        <TitleSection
                :headerVisible="visibleParty"
                :title="this.titleParty"
        />
        <div
                v-for="dataTitle in sectionData"
                :key="dataTitle"
        >
        ...
        <div class="party-container" :style="listResearch">
            <div
                    class="party-block"
                    v-for="dataUsers in dataTitle.users"
                    :key="dataUsers"
            >
            ...
            <p v-if="dataTitle.users.length > 6"
...
<style scoped>
    ...
    .party-block{
        ...
        border-radius: 10px;
        text-align: left;
        box-shadow: 8px 8px 5px -6px rgba(0, 0, 0, .2);
