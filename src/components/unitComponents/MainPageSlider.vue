...
export default {
    ...
    async mounted() {
        ...
        $('.news-slider__slide:nth-child(2)')
            ...
            .css(
                'display',
                this.sliderData[this.sliderDataIndex].pageLink === ''
                    ? 'none'
                    : 'block'
            );
        ...
        $('.news-slider__slide:nth-child(1)')
            ...
            .css(
                'display',
                this.sliderData[this.sliderDataIndex + 1].pageLink === ''
                    ? 'none'
                    : 'block'
            );
        $('.news-slider__slide:nth-child(3)')
            ...
            .css(
                'display',
                this.sliderData[this.sliderData.length - 1].pageLink === ''
                    ? 'none'
                    : 'block'
            );
        $('.news-slider__dot')
            ...
            if (isNext) {
                ...
                setTimeout(() => {
                    this.circles
                        ...
                        .css(
                            'display',
                            this.sliderData[nextImageIndex].pageLink === ''
                                ? 'none'
                                : 'block'
                        );
                }, 1000);
                ...
                setTimeout(() => {
                    this.circles
                        ...
                        .css(
                            'display',
                            this.sliderData[prevImageIndex].pageLink === ''
                                ? 'none'
                                : 'block'
                        );
                }, 1000);
