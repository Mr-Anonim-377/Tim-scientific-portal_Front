    ...
    <footer class="footerSection">
        ...
        <div class="footerNav">
            <div class="footerNav-container">
                ...
                <div class="footerNav-item">
                    <h3>Исследователи НЦМУ</h3>

                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи РГАУ</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи СПГУ</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи ФГУП ВНИМС</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи ФИЦ им. В.В. Докучаева</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи ВИГРР</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>Исследователи ФИЦ "Информатика и управление" РАН</p>
                    </router-link>
                    <router-link
                        style="text-decoration: none"
                        :to="{ name: 'notFound' }"
                    >
                        <p>
                            Исследователи ФИЦ "Фундаментальные основы
                            биотехнологии" РАН
                        </p>
                    </router-link>
                </div>
                <div class="footerNav-item">
                    ...
                    <router-link
                        ...
                        :to="{ name: 'notFound' }"
                    >
                        <p>Новости по направлениям исследований</p>
                    </router-link>
                </div>
            </div>
        </div>
        ...
        <div class="footer-links">
            ...
            <div class="footer-police">
                ...
                <div class="footer-police__text">
                    <p>
                        ©2020 <q>Агроконсорциум</q> <br />Научный центр мирового
                        уровня
                        <!-- <br /> -->
...
.footerContact__networks {
    display: flex;
    margin: 0 -11px;
}
.footerContact__networks img {
    margin: 0 11px;
}
</style>
